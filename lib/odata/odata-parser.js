    ...
    const result = {
        ...
        parse: function (input, startRule) {
            ...
            function parse_binary() {
                ...
                if (result0 === null) {
                    if (input.slice(pos, pos + 6) === 'binary') {
                        result0 = 'binary';
                        pos += 6;
                    } else {
                        result0 = null;
            ...
            function parse_dateTime() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 8) === 'datetime') {
                    result0 = 'datetime';
                    pos += 8;
                } else {
                    result0 = null;
            ...
            function parse_dateTimeOffset() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 14) === 'datetimeoffset') {
            ...
            function parse_double() {
                ...
                if (result0 !== null) {
                    result0 = (function (offset, sign, digit, decimal, signexp, exp) {
                        return sign + digit + '.' + decimal.join('') + 'e' + signexp + exp.join('');
            ...
            function parse_callback() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 10) === '$callback=') {
                    result0 = '$callback=';
                    pos += 10;
                } else {
                    result0 = null;
            ...
            function parse_top() {
                ...
                if (result0 === null) {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset) {
                            return {error: 'invalid $top parameter'};
                        })(pos0);
                    }
                    if (result0 === null) {
                        pos = pos0;
            ...
            function parse_expand() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 8) === '$expand=') {
                    result0 = '$expand=';
                    pos += 8;
                } else {
                    result0 = null;
                ...
                if (result0 === null) {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset) {
                            return {error: 'invalid $expand parameter'};
                        })(pos0);
                    }
                    if (result0 === null) {
                        pos = pos0;
            ...
            function parse_format() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 8) === '$format=') {
                    result0 = '$format=';
                    pos += 8;
                } else {
                    result0 = null;
            ...
            function parse_inlinecount() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 13) === '$inlinecount=') {
                    result0 = '$inlinecount=';
                    pos += 13;
                } else {
                    result0 = null;
                ...
                if (result0 !== null) {
                    if (input.slice(pos, pos + 8) === 'allpages') {
                        result1 = 'allpages';
                        pos += 8;
                    } else {
                        result1 = null;
            ...
            function parse_orderby() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 9) === '$orderby=') {
                    result0 = '$orderby=';
                    pos += 9;
                } else {
                    result0 = null;
            ...
            function parse_select() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 8) === '$select=') {
                    result0 = '$select=';
                    pos += 8;
                } else {
                    result0 = null;
            ...
            function parse_filter() {
                ...
                pos0 = pos;
                pos1 = pos;
                if (input.slice(pos, pos + 8) === '$filter=') {
                    result0 = '$filter=';
                    pos += 8;
                } else {
                    result0 = null;
            ...
            function parse_booleanFunctions2Args() {
                ...
                if (input.slice(pos, pos + 11) === 'substringof') {
                    result0 = 'substringof';
                    pos += 11;
                } else {
                    result0 = null;
                ...
                if (result0 === null) {
                    if (input.slice(pos, pos + 8) === 'endswith') {
                        result0 = 'endswith';
                        pos += 8;
                    } else {
                        result0 = null;
                    ...
                    if (result0 === null) {
                        if (input.slice(pos, pos + 10) === 'startswith') {
                            result0 = 'startswith';
                            pos += 10;
                        } else {
                            result0 = null;
                        ...
                        if (result0 === null) {
                            ...
                            if (result0 === null) {
                                if (input.slice(pos, pos + 8) === 'contains') {
                                    result0 = 'contains';
                                    pos += 8;
                                } else {
                                    result0 = null;
            ...
            function parse_otherFunctions1Arg() {
                ...
                if (input.slice(pos, pos + 7) === 'tolower') {
                    result0 = 'tolower';
                    pos += 7;
                } else {
                    result0 = null;
                ...
                if (result0 === null) {
                    if (input.slice(pos, pos + 7) === 'toupper') {
                        result0 = 'toupper';
                        pos += 7;
                    } else {
                        result0 = null;
                    ...
                    if (result0 === null) {
                        ...
                        if (result0 === null) {
                            if (input.slice(pos, pos + 6) === 'length') {
                                result0 = 'length';
                                pos += 6;
                            } else {
                                result0 = null;
                            ...
                            if (result0 === null) {
                                ...
                                if (result0 === null) {
                                    if (input.slice(pos, pos + 5) === 'month') {
                                        result0 = 'month';
                                        pos += 5;
                                    } else {
                                        result0 = null;
                                    ...
                                    if (result0 === null) {
                                        ...
                                        if (result0 === null) {
                                            ...
                                            if (result0 === null) {
                                                if (input.slice(pos, pos + 6) === 'minute') {
                                                    result0 = 'minute';
                                                    pos += 6;
                                                } else {
                                                    result0 = null;
                                                ...
                                                if (result0 === null) {
                                                    if (input.slice(pos, pos + 6) === 'second') {
                                                        result0 = 'second';
                                                        pos += 6;
                                                    } else {
                                                        result0 = null;
                                                    ...
                                                    if (result0 === null) {
                                                        if (input.slice(pos, pos + 5) === 'round') {
                                                            result0 = 'round';
                                                            pos += 5;
                                                        } else {
                                                            result0 = null;
                                                        ...
                                                        if (result0 === null) {
                                                            if (input.slice(pos, pos + 5) === 'floor') {
                                                                result0 = 'floor';
                                                                pos += 5;
                                                            } else {
                                                                result0 = null;
                                                            ...
                                                            if (result0 === null) {
                                                                if (input.slice(pos, pos + 7) === 'ceiling') {
                                                                    result0 = 'ceiling';
                                                                    pos += 7;
                                                                } else {
                                                                    result0 = null;
            ...
            function parse_otherFunctions2Arg() {
                ...
                if (input.slice(pos, pos + 7) === 'indexof') {
                    result0 = 'indexof';
                    pos += 7;
                } else {
                    result0 = null;
                ...
                if (result0 === null) {
                    if (input.slice(pos, pos + 6) === 'concat') {
                        result0 = 'concat';
                        pos += 6;
                    } else {
                        result0 = null;
                    ...
                    if (result0 === null) {
                        if (input.slice(pos, pos + 9) === 'substring') {
                            result0 = 'substring';
                            pos += 9;
                        } else {
                            result0 = null;
                        ...
                        if (result0 === null) {
                            if (input.slice(pos, pos + 7) === 'replace') {
                                result0 = 'replace';
                                pos += 7;
                            } else {
                                result0 = null;
            ...
            function parse_unsupported() {
                ...
                if (result0 !== null) {
                    result0 = (function (offset, er) {
                        return {error: 'unsupported method: ' + er};
                    })(pos0, result0[1]);
                }
                if (result0 === null) {
                    pos = pos0;
            ...
            function parse_query() {
                ...
                if (result0 !== null) {
                    result0 = (function (offset, list) {
                        ...
                        for (let i in list) {
                            if (list[i] !== '') {
                                let paramName = Object.keys(list[i])[0]; //ie: $top
